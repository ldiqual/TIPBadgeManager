...
public class TIPViewObject: NSObject, TIPBadgeObject{
    ...
    func addBadge(){
       ...
       bv!.translatesAutoresizingMaskIntoConstraints = false
        ...
        let rightConstraint = NSLayoutConstraint(item: self.view!, attribute: .right, relatedBy: .equal, toItem: bv!, attribute: .left, multiplier: 1.0, constant: 7.0)
        
        let topConstraint = NSLayoutConstraint(item: self.view!, attribute: .top, relatedBy: .equal, toItem: bv!, attribute: .top, multiplier: 1.0, constant: 5.0)
